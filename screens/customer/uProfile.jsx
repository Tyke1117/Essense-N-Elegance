    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.profileCard}>
          ...
          <Text style={styles.email}>p</Text>
        </View>
        ...
        <TouchableOpacity onPress={()=>navigation.replace("retailerStack")}>
        <View style={[styles.btn]}>
          <Text style={[styles.btnTxt,{paddingVertical:14}]}>Become a Retailer</Text>
